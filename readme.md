...
[![Email](https://img.shields.io/badge/Email-5223sho%40gmail.com-EA4335?style=flat-square&logo=gmail&logoColor=white)](mailto:5223sho@gmail.com)
...
- 학사 과정
- 학점: **4.1 / 4.5**
- 주요 과목: 자료구조, 객체지향프로그래밍, 데이터베이스, 소프트웨어공학, 영상처리 등
- AI 연구실 활동 및 캡스톤/졸업작품 프로젝트 참여

<br />

### 그린컴퓨터아카데미 / BNK부산은행 금융DT 아카데미
`2025.07 ~ 2026.01`

- 생성형 AI 활용, Java, Spring, Flutter 기반 개발자 양성과정
- 디지털 금융, 데이터 모델링, Java / Spring Boot, Flutter 학습
- 금융 서비스 웹/앱 프로젝트 수행
- **FLOBANK 1차·2차 프로젝트 최우수상 수상**
...
- 학부연구생으로 AI 연구, 세미나, 논문 작성, 저작권 출원 참여
- **Rain2FloodNet** 연구 및 논문 1저자
- **SAFE S Viewer** DB 모델링 참여
- 서비스 개발 및 실험적 프로젝트 참여
...
![Linux](https://img.shields.io/badge/Linux-FCC624?style=flat-square&logo=linux&logoColor=222)
...
궁금한 점이나 함께 이야기하고 싶은 프로젝트가 있다면 편하게 연락 주세요.

**Email** · [5223sho@gmail.com](mailto:5223sho@gmail.com)<br />
