...
| --- | --- |
| 2025.12 | 정보처리기사 |
| 2024.12 | SQLD(SQL 개발자) |
| 2017.03 | 컴퓨터활용능력 2급 |
| 2026.01 | TOEIC Speaking 120 (IM2) |
...
- 학부연구생으로 AI 연구, 세미나, 논문 작성 및 서비스·기술 저작권 등록 프로젝트 참여
- **Rain2FloodNet** 연구 및 논문 1저자
- **SAFE S Viewer** 수술 마취 기록 시스템의 데이터 구조 설계, 화면 구현 및 기능 흐름 설계 참여
