...
- 🏦 금융 서비스, 계정계/채널계 구조, 외환·송금 도메인에 관심이 많습니다.
- 🧩 Spring Boot, MyBatis, Oracle 기반의 백엔드 개발을 주로 학습하고 구현합니다.
- 🤖 AI 챗봇, OCR, 음성 비서, 컴퓨터비전 모델을 서비스에 연결하는 프로젝트를 경험했습니다.
- 🚀 배포, CI/CD, DB 설계, 비동기 처리까지 서비스 전체 흐름을 이해하는 개발자를 지향합니다.
